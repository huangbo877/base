...
import com.xpzones.utils.PxUtils;
...
public class ActionBar extends RelativeLayout {
    ...
    private void initView(Context context) {
        rootView = View.inflate(context, R.layout.base_head, this);
    ...
    public void setCenterText(CharSequence text, OnClickListener l) {
        ...
        center.getPaint().setFakeBoldText(true);
    ...
    public void showBackImg(boolean show) {
        if (show) {
            setLeftIcon(R.drawable.home_icon_close, new OnClickListener() {
                @Override
     ...
     * 显示默认的左边的按钮
     */
    public void showBackImg(boolean show,OnClickListener l) {
        if (show) {
            setLeftIcon(R.drawable.home_icon_close, l);
        } else {
            llLeft.setVisibility(INVISIBLE);
        }
    }
    ...
    public ImageView getImageView() {
        ...
        iv.setLayoutParams(new android.app.ActionBar.LayoutParams(PxUtils.dp2px(getContext(), 25), PxUtils.dp2px(getContext(), 25)));
        return iv;
